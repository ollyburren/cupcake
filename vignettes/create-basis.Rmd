...
Here we can see that with 'No shrinkage', relationships between basis traits seem less clear and UKBB:SLE cluster with 'control'. 'With shrinkage' our hypothesis is bourne out such that UKBB:SLE projection clusters with the basis SLE.
